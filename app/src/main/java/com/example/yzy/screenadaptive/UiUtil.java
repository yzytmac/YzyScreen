...
public class UiUtil {
    ...
    private static final int BASE_WIDTH = 1080;//美工的基准
    ...
    private UiUtil(Context pContext) {
        //获取屏幕真是宽高
    ...
    private int getSystemBarHeight(Context pContext) {
        try {
            ...
            Field vField = clazz.getField(SYSTEM_BAR_HEIGHT);
    ...
    public int getHeight(float uiHeight){
        return (int) (uiHeight*displayWidth/BASE_HEIGHT);
    }
